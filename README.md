# Installs [Scalafmt CLI Native:2.5.3](https://scalameta.org/scalafmt/) on [Ubuntu](https://www.ubuntu.com/)
...
```bash
wget -q https://script.install.devinsideyou.com/scalafmt-cli-native
sudo chmod +x scalafmt-cli-native && ./scalafmt-cli-native 2.5.3
```
